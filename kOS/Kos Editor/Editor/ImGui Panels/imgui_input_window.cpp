...
void gui::ImGuiHandler::DrawInputWindow() {
	...
	std::string mousePos = "Mouse Position: (" + std::to_string(static_cast<int>(Input::InputSystem::inputSystem->mousePos.x)) + " , " + std::to_string(static_cast<int>(Input::InputSystem::inputSystem->mousePos.y)) + ")";
	ImGui::Text(mousePos.c_str());
	
	std::string clickedID = "Clicked ID: (" + std::to_string(m_clickedEntityId) + ")";
	ImGui::Text(clickedID.c_str());

	//std::string keyStatus = "Key Status: " + Input::InputSystem::inputSystem->keyString;
	//ImGui::Text(keyStatus.c_str());

	//std::string mouseStatus = "MouseButton Status: " + Input::InputSystem::inputSystem->mouseString;
